...
import { BadgeCheck, CircleDashed, Clock3, FileX2, Search, SlidersHorizontal } from "lucide-react";
...
function InvoiceDetail({ invoice }: { invoice: Invoice }) {
  ...
  return <aside className="invoice-detail-panel"><header><h2>Invoice Details</h2><div><button>Edit</button><button>Hold</button><button>Send Invoice</button></div></header><section className="invoice-document">
